...
Project skill content`,
	...
	describe("system prompt sources", () => {
		it("does not expose ignored project SYSTEM.md as the system prompt source", async () => {
		...
		it("does not expose ignored APPEND_SYSTEM.md as an append system prompt source", async () => {
			const piDir = join(cwd, ".pi");
